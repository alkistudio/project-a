...
public class CommandManager : MonoBehaviour
{
    ...
    private void AttackCommandExecute()
    {
        ...
        LoadBattleScene(receiver.gameObject, currentCommand.target.gameObject);
        currentCommand = null;
        //Scene targetScene = SceneManager.GetSceneByName("BattleScene");
        //StartCoroutine(SetActive(targetScene));
    ...
    private void LoadBattleScene(GameObject attacker, GameObject target)
    {
        battleSceneTransition.attackingCharacter = attacker;
        battleSceneTransition.receivingCharacter = target;

        battleSceneTransition.attackerIchor = attacker.GetComponent<Character>().ichor;
        battleSceneTransition.targetIchor = target.GetComponent<Character>().ichor;

        Debug.Log(battleSceneTransition.attackingCharacter);
        Debug.Log(battleSceneTransition.receivingCharacter);
